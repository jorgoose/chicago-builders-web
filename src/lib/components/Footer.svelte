	...
	<div class="mx-auto max-w-6xl px-4 md:px-6">
		<div class="flex flex-col items-center justify-between gap-6 md:flex-row">
			...
			<div class="flex items-center gap-6">
				<a href="/" class="text-sm text-white/60 transition-colors hover:text-white">Home</a>
				<a href="/details" class="text-sm text-white/60 transition-colors hover:text-white">Details</a>
				<a href="/why-chicago" class="text-sm text-white/60 transition-colors hover:text-white">Why Chicago</a>
				<a
